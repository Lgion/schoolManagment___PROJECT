...
const classeSchema = mongoose.Schema({
    // professeur_$_ref_µ_teachers: { default: [], type: [ObjectId], ref: Object.keys(schemaTeacher.obj)[0], required: true },
    professeur_$_ref_µ_teachers: { default: [], type: [Object], required: true },
    // eleves_$_ref_µ_eleves: { default: [], type: [ObjectId], ref: Object.keys(schemaStudent.obj)[0], required: true },
...
const studentSchema = mongoose.Schema({
    // current_classe_$_ref_µ_classes: { default: "", type: ObjectId, ref: Object.keys(classeSchema.obj)[0], required: true },
    ...
    //   contentType: String,
    // },
    scolarity_fees_$_checkbox: { default: {[currentSchoolYear]: false}, type: Object }, // => {YYYY: {}}
...
const teacherSchema = mongoose.Schema({
    // current_classes_$_ref_µ_classes: { default: "", type: ObjectId, ref: Object.keys(classeSchema.obj)[0], required:true },
    ...
    adresse_$_map: { default: "", type: String, required:true },
    photo_$_file: { default: "", type: String, required:true },
    phone_$_tel: { default: "+2250102030465", type: String, required:true },
